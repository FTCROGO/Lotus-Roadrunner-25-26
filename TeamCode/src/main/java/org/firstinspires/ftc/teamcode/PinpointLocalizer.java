...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1902.692308; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 1455; // x position of the perpendicular encoder (in tick units)
    }
