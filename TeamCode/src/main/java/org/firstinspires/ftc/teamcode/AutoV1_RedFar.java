...
public class AutoV1_RedFar extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d shootPose = new Pose2d(53, 12, Math.toRadians(160));
        Pose2d intake1Pose = new Pose2d(37, 27, Math.toRadians(90));
        Pose2d intake2Pose = new Pose2d(37, 33, Math.toRadians(90));
        Pose2d intake3Pose = new Pose2d(37, 53, Math.toRadians(90));

        Vector2d shootVec = new Vector2d(53, 12);
        Vector2d intake1Vec = new Vector2d(37, 27);
        Vector2d intake2Vec = new Vector2d(37, 33);
        Vector2d intake3Vec = new Vector2d(37, 53);
        ...
        TrajectoryActionBuilder initToShoot = drive.actionBuilder(initPose)
                .strafeToLinearHeading(shootVec, Math.toRadians(160));
