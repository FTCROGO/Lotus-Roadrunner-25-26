...
public class AutoV1_RedGoal extends LinearOpMode {
    ...
    public void runOpMode() {
        Pose2d initPose = new Pose2d(-63.5, 24, Math.toRadians(315));
        Pose2d shootPose = new Pose2d(-9, 2, Math.toRadians(135));
        Pose2d intake1Pose = new Pose2d(-18, 29, Math.toRadians(90));
        Pose2d intake2Pose = new Pose2d(-18, 33, Math.toRadians(90));
        Pose2d intake3Pose = new Pose2d(-18, 40, Math.toRadians(90));
        ...
        TrajectoryActionBuilder intake3ToShoot = drive.actionBuilder(intake3Pose)
                .strafeToLinearHeading(shootVec, Math.toRadians(45));
