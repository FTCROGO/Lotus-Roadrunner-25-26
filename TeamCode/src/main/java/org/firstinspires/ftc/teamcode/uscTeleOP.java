...
@TeleOp(name = "Robot: uscTeleOP ", group = "Robot")
public class uscTeleOP extends LinearOpMode {
    ...
    // -------- Flywheel speed prediction model (distance inches -> rpm) --------
    ...
    private static final double LED_RPM_TOL = 150;
    ...
    private void driveFieldCentricWithOptionalAimAssist() {
        ...
        telemetry.addData("IMU Yaw", "%.1f°", Math.toDegrees(yawRad));
    }
